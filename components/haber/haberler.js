...
const HaberYapici = (haber) => {
  ...
  p1.textContent = haber.tarih;
  p2.textContent = haber.ilkParagraf;
  p3.textContent = haber.ikinciParagraf;
  p4.textContent = haber.ucuncuParagraf;
  ...
  div1.append(h2, p1, p2, p3, p4, buton);
  return div1;
};

const articlesSelect = document.querySelector('.articles');

data.forEach((haber) => {
  articlesSelect.appendChild(HaberYapici(haber));
});
/*
